...
GC_14 = Coupling(name = 'GC_14',
                 value = '(-3*cmup)/(Lambda**2*cmath.sqrt(2))',
                 order = {'NP':2,'QED':3})

GC_15 = Coupling(name = 'GC_15',
                 value = '-(cmup/(Lambda**2*cmath.sqrt(2)))',
                 order = {'NP':2,'QED':3})

GC_16 = Coupling(name = 'GC_16',
                 value = '(cmup*complex(0,1))/(Lambda**2*cmath.sqrt(2))',
                 order = {'NP':2,'QED':3})

GC_17 = Coupling(name = 'GC_17',
                 value = '(3*cmup*complex(0,1))/(Lambda**2*cmath.sqrt(2))',
                 order = {'NP':2,'QED':3})
...
GC_44 = Coupling(name = 'GC_44',
                 value = '-((cmup*vev)/(Lambda**2*cmath.sqrt(2)))',
                 order = {'NP':2,'QED':2})

GC_45 = Coupling(name = 'GC_45',
                 value = '(cmup*complex(0,1)*vev)/(Lambda**2*cmath.sqrt(2))',
                 order = {'NP':2,'QED':2})

GC_46 = Coupling(name = 'GC_46',
                 value = '(3*cmup*complex(0,1)*vev)/(Lambda**2*cmath.sqrt(2))',
                 order = {'NP':2,'QED':2})
...
GC_48 = Coupling(name = 'GC_48',
                 value = '(cmup*complex(0,1)*vev**2)/(Lambda**2*cmath.sqrt(2))',
                 order = {'NP':2,'QED':1})
