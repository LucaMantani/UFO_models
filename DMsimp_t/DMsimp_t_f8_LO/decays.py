...
Decay_F8 = Decay(name = 'Decay_F8',
                 particle = P.F8,
                 partial_widths = {(P.g,P.Xd):'((MF8**2 - MXd**2)*((128*gd**2*MF8**4)/Lambda**2 - (256*gd**2*MF8**2*MXd**2)/Lambda**2 + (128*gd**2*MXd**4)/Lambda**2))/(256.*cmath.pi*abs(MF8)**3)'})
...
Decay_Xd = Decay(name = 'Decay_Xd',
                 particle = P.Xd,
                 partial_widths = {(P.g,P.F8):'((-MF8**2 + MXd**2)*((128*gd**2*MF8**4)/Lambda**2 - (256*gd**2*MF8**2*MXd**2)/Lambda**2 + (128*gd**2*MXd**4)/Lambda**2))/(32.*cmath.pi*abs(MXd)**3)'})
