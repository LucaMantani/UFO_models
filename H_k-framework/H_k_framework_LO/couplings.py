...
GC_16 = Coupling(name = 'GC_16',
                 value = '-6*delta4*complex(0,1)*lam',
                 order = {'NPH4':1,'QED':2})
...
GC_20 = Coupling(name = 'GC_20',
                 value = '(deltaVVHH*ee**2*complex(0,1))/(2.*sw**2)',
                 order = {'NPVVHH':1,'QED':2})

GC_21 = Coupling(name = 'GC_21',
                 value = '(deltaVVHH*ee**2*complex(0,1))/(2.*cw**2*sw**2)',
                 order = {'NPVVHH':1,'QED':2})
...
GC_42 = Coupling(name = 'GC_42',
                 value = '(3*deltaVVHHH*ee**2*complex(0,1))/(2.*sw**2*vev)',
                 order = {'NPVVHHH':1,'QED':3})

GC_43 = Coupling(name = 'GC_43',
                 value = '(3*deltaVVHHH*ee**2*complex(0,1))/(2.*cw**2*sw**2*vev)',
                 order = {'NPVVHHH':1,'QED':3})
...
GC_48 = Coupling(name = 'GC_48',
                 value = '-6*delta3*complex(0,1)*lam*vev',
                 order = {'NPH3':1,'QED':1})
...
GC_53 = Coupling(name = 'GC_53',
                 value = '(deltaVVH*ee**2*complex(0,1)*vev)/(2.*sw**2)',
                 order = {'NPVVH':1,'QED':1})

GC_54 = Coupling(name = 'GC_54',
                 value = '(deltaVVH*ee**2*complex(0,1)*vev)/(2.*cw**2*sw**2)',
                 order = {'NPVVH':1,'QED':1})
