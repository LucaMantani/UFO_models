...
Decay_H = Decay(name = 'Decay_H',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-12*MB**2*yb**2 + 3*MH**2*yb**2)*cmath.sqrt(-4*MB**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.W__minus__,P.W__plus__):'(((3*ee**4*vev**2)/(4.*sw**4) + (3*deltaVVH*ee**4*vev**2)/(2.*sw**4) + (3*deltaVVH**2*ee**4*vev**2)/(4.*sw**4) + (ee**4*MH**4*vev**2)/(16.*MW**4*sw**4) + (deltaVVH*ee**4*MH**4*vev**2)/(8.*MW**4*sw**4) + (deltaVVH**2*ee**4*MH**4*vev**2)/(16.*MW**4*sw**4) - (ee**4*MH**2*vev**2)/(4.*MW**2*sw**4) - (deltaVVH*ee**4*MH**2*vev**2)/(2.*MW**2*sw**4) - (deltaVVH**2*ee**4*MH**2*vev**2)/(4.*MW**2*sw**4))*cmath.sqrt(MH**4 - 4*MH**2*MW**2))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.Z,P.Z):'(((9*ee**4*vev**2)/2. + (3*deltaVVH*ee**4*vev**2)/(2.*cw**4) + (3*ee**4*MH**4*vev**2)/(8.*MZ**4) + (deltaVVH*ee**4*MH**4*vev**2)/(8.*cw**4*MZ**4) - (3*ee**4*MH**2*vev**2)/(2.*MZ**2) - (deltaVVH*ee**4*MH**2*vev**2)/(2.*cw**4*MZ**2) + (3*cw**4*ee**4*vev**2)/(4.*sw**4) + (3*deltaVVH*ee**4*vev**2)/(2.*sw**4) + (3*deltaVVH**2*ee**4*vev**2)/(4.*cw**4*sw**4) + (cw**4*ee**4*MH**4*vev**2)/(16.*MZ**4*sw**4) + (deltaVVH*ee**4*MH**4*vev**2)/(8.*MZ**4*sw**4) + (deltaVVH**2*ee**4*MH**4*vev**2)/(16.*cw**4*MZ**4*sw**4) - (cw**4*ee**4*MH**2*vev**2)/(4.*MZ**2*sw**4) - (deltaVVH*ee**4*MH**2*vev**2)/(2.*MZ**2*sw**4) - (deltaVVH**2*ee**4*MH**2*vev**2)/(4.*cw**4*MZ**2*sw**4) + (3*cw**2*ee**4*vev**2)/sw**2 + (3*deltaVVH*ee**4*vev**2)/(cw**2*sw**2) + (cw**2*ee**4*MH**4*vev**2)/(4.*MZ**4*sw**2) + (deltaVVH*ee**4*MH**4*vev**2)/(4.*cw**2*MZ**4*sw**2) - (cw**2*ee**4*MH**2*vev**2)/(MZ**2*sw**2) - (deltaVVH*ee**4*MH**2*vev**2)/(cw**2*MZ**2*sw**2) + (3*ee**4*sw**2*vev**2)/cw**2 + (ee**4*MH**4*sw**2*vev**2)/(4.*cw**2*MZ**4) - (ee**4*MH**2*sw**2*vev**2)/(cw**2*MZ**2) + (3*ee**4*sw**4*vev**2)/(4.*cw**4) + (ee**4*MH**4*sw**4*vev**2)/(16.*cw**4*MZ**4) - (ee**4*MH**2*sw**4*vev**2)/(4.*cw**4*MZ**2))*cmath.sqrt(MH**4 - 4*MH**2*MZ**2))/(32.*cmath.pi*abs(MH)**3)'})
