...
V_38 = Vertex(name = 'V_38',
              particles = [ P.FeR__tilde__, P.FeR, P.a ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_5})

V_39 = Vertex(name = 'V_39',
              particles = [ P.FeL__tilde__, P.FeL, P.a ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_5})
...
V_64 = Vertex(name = 'V_64',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_76,(0,1):C.GC_70})

V_65 = Vertex(name = 'V_65',
              particles = [ P.d__tilde__, P.c, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_74,(0,1):C.GC_80})
...
V_67 = Vertex(name = 'V_67',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_99,(0,1):C.GC_71})

V_68 = Vertex(name = 'V_68',
              particles = [ P.d__tilde__, P.t, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_97,(0,1):C.GC_81})
...
V_70 = Vertex(name = 'V_70',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_108,(0,1):C.GC_69})

V_71 = Vertex(name = 'V_71',
              particles = [ P.d__tilde__, P.u, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_106,(0,1):C.GC_79})

V_72 = Vertex(name = 'V_72',
              particles = [ P.s__tilde__, P.u, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_107,(0,1):C.GC_92})
...
V_79 = Vertex(name = 'V_79',
              particles = [ P.ve__tilde__, P.FvL, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_1})

V_80 = Vertex(name = 'V_80',
              particles = [ P.e__plus__, P.FeL, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_1})

V_81 = Vertex(name = 'V_81',
              particles = [ P.FeR__tilde__, P.e__minus__, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_2})

V_82 = Vertex(name = 'V_82',
              particles = [ P.e__plus__, P.FeR, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_2})

V_83 = Vertex(name = 'V_83',
              particles = [ P.FvL__tilde__, P.ve, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_1})

V_84 = Vertex(name = 'V_84',
              particles = [ P.FeL__tilde__, P.e__minus__, P.Xs ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_1})
...
V_91 = Vertex(name = 'V_91',
              particles = [ P.FeL__tilde__, P.FvL, P.W__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
...
V_97 = Vertex(name = 'V_97',
              particles = [ P.FvL__tilde__, P.FeL, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_24})
...
V_111 = Vertex(name = 'V_111',
               particles = [ P.FeL__tilde__, P.FeL, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_46})

V_112 = Vertex(name = 'V_112',
               particles = [ P.FvL__tilde__, P.FvL, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_47})

V_113 = Vertex(name = 'V_113',
               particles = [ P.FeR__tilde__, P.FeR, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
...
V_165 = Vertex(name = 'V_165',
               ...
               couplings = {(0,0):C.GC_35,(0,1):C.GC_42})
...
V_168 = Vertex(name = 'V_168',
               ...
               couplings = {(0,0):C.GC_34,(0,1):C.GC_42})
