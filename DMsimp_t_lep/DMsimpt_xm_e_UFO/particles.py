...
SeL__tilde__ = SeL.anti()

SvL = Particle(pdg_code = 9999997,
               name = 'SvL',
               antiname = 'SvL~',
               spin = 1,
               color = 1,
...
SvL__tilde__ = SvL.anti()

SeR = Particle(pdg_code = 9999998,
               name = 'SeR',
               antiname = 'SeR~',
               spin = 1,
               color = 1,
