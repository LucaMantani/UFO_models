...
Decay_Xc = Decay(name = 'Decay_Xc',
                 particle = P.Xc,
                 partial_widths = {(P.YF3u,P.u__tilde__):'((-1.6e7 + MXc**2)*(0. - 4.8e7*lamF3u**2 + 3*lamF3u**2*MXc**2))/(16.*cmath.pi*abs(MXc)**3)'})

Decay_YF3u = Decay(name = 'Decay_YF3u',
                   particle = P.YF3u,
                   partial_widths = {(P.Xc,P.u):'5.1808249704393013e-14*(1.6e7 - MXc**2)*(0. + 4.8e7*lamF3u**2 - 3*lamF3u**2*MXc**2)'})
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.YF3u,P.YF3u__tilde__):'((0. + (1.706666666666667e8*ee**2*sw**2)/cw**2 + (16*ee**2*MZ**2*sw**2)/(3.*cw**2))*cmath.sqrt(0. - 6.4e7*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)'})
